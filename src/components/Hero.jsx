  ...
  return (
    <section className='p-9'>
      <div className='flex flex-col justify-center items-center text-center'>
        ...
        <p className='text-white text-body font-raleway font-fontWeight400 mt-4 max-w-80'>Fylo stores all your most important files in one secure location. Access them wherever
